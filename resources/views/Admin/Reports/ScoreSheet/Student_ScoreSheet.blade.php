...
<x-default-layout>
    ...
    {{-- <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td rowspan="{{count($element->chapter->lessons)}}" style="border: 1px solid #ccc">
                    {{$element->chapter->chapter_name}}</td>
                @endif
                ...
                <td style="border: 1px solid #ccc">
                    {{\Carbon\Carbon::parse($student_quizzes->created_at)->format('d-m-Y')}}</td>
                @endif
                <td style="border: 1px solid #ccc">
                    @if (!empty($student_quizzes->id))
                    <a href="{{route('quizze_mistakes', ['id' => $student_quizzes->id])}}"
                        class="btn btn-primary mistake_btn">
                        View Mistakes
                    </a>
                    @endif
                </td>
                <td style="border: 1px solid #ccc">
                    @if (!empty($student_quizzes->id))
                    <a href="{{route('quizze_report', ['id' => $student_quizzes->id])}}"
                        class="btn btn-primary mistake_btn">
                        Report
                    </a>
                    @endif
