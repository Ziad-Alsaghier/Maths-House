...
<x-default-layout>
    ...
    <div class="mb-4" style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px; border-radius: 10px; padding: 30px;" >
        <form action="{{route('Ad_report_video_list_add')}}" method="POST">
            @csrf
            ...
            <tbody class="fs-6">
                ...
                <tr>
                    ...
                    <div class="mt-3">
                                ...
                                <!-- Modal -->
                                <form method="POST" action="{{route('Ad_report_video_list_edit', ['id' => $item->id])}}" enctype="multipart/form-data">
                                  @csrf
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a href="{{route('Ad_report_video_list_del', ['id'=>$item->id])}}" class="btn btn-danger">Delete</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
