                            ...
                            <div class="modal fade" id="kt_modal_create_question" tabindex="-1" aria-hidden="true">
                                ...
                                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                    ...
                                    <li class="nav-item mt-2">
                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route('stu_details', ['id' => $user->id])}}">Student</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item mt-2">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <span class="fw-semibold text-gray-800 fs-6">{{$user->nick_name}}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
