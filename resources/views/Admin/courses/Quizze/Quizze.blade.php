...
<x-default-layout>
            ...
            <div class="modal-content" style="border-radius: 15px;">
                <form action="{{ route('add_quizze') }}" method="POST">
                    ...
                    <div class="modal-header" style="border-bottom: 0 !important;">
                        <h2 class="modal-title" id="exampleModalLongTitle">New Quiz</h2>
                            ...
                            <div class="tab-pane container active"
                                ...
                                <div class=""
                                        ...
                                        <div class="col-md-9"
                                            ...
                                            <div class="d-flex col-md-2"
                                                ...
                                                <input type="number" name="time_h" max="3" min="0"
                                                    value="0" class="col-md-4 form-control">
                                            </div>
                                            <div class="d-flex col-md-2"
                                                style="align-items: center;padding: 0;  column-gap: 10px">
                                                <span>Minets: </span>
                                    ...
                                    <div class="col-md-12 d-flex align-items-center justify-content-around">
                                        ...
                                        <input type="number" min="0" name="quizze_order"
                            ...
                            <div class="tab-pane container fade"
                                ...
                                <div class=""
                                    ...
                                    <div class="d-flex"
                                        ...
                                        <span style="font-size: 1.2rem;font-weight: 600;">Filter Quiz :</span>
                                    ...
                                    <div class="d-flex" style="align-items: center; justify-content: center">
                                        <span
                                            style="font-size: 2rem;font-weight: 500;background: #1b84ff;color: #fff;border-radius: 10px;padding: 10px 15px;margin-top: 10px;">Quizs</span>
                                    </div>
                                                    ...
                                                    <div class="tab-pane container active"
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <div
                                                                class="col-md-12 d-flex align-items-center justify-content-around">
                                                                <span class="col-md-2"
                                                                    style="font-size: 1.2rem;">Quizze Order </span>
                                                    ...
                                                    <div class="tab-pane container fade question_edit_parQ"
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <div class="d-flex all_filter"
                                                                ...
                                                                <div class="col-md-2 d-flex filterBtn_edit"
                                                                    style="align-items: center; column-gap:10px">
                                                                    <button type="button" id="filterBtn_edit"
                                                                        style="font-size: 1.4rem;font-weight: 500;border: none;background: #1b84ff;border-radius: 8px;padding: 5px 25px;letter-spacing: 1px;color: #fff;">Filter</button>
                                                                </div>
                                                            ...
                                                            <input class="course" type="hidden"
                                                                value="{{ $courses }}" />
                                                            <input class="chapter" type="hidden"
                                                                value="{{ $chapters }}" />
                                                            <input class="lesson" type="hidden"
                                                                value="{{ $lessons }}" />
    ...
    <script>
        ...
        let sel_lesson = document.querySelector('#sel_less');
                ...
                success: function(data) {
                    if (data.faild == undefined) {
                        ...
                        $(document).on('click', ".add_qz", function() {
                            ...
                            var myObjectDeserialized = JSON.parse(localStorage.getItem(
                                "quizzes"));
                            ...
                            myObjectDeserialized.forEach(element => {
                                ...
                                dynamicTR = dynamicTR + "<td class='iddd'> " + index +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.type +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.year +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.month +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.code +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.section +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.noNum +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.diff +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.chap +
                                    "</td>";
                                dynamicTR = dynamicTR + "<td> " + element.less +
                                    "</td>";
                                dynamicTR = dynamicTR +
    ...
    <script>
        ...
        //                                 </option>`;
            ...
            $(document).on("click", ".btn_Edit_quizze", function() {
                ...
                var quizzeID = $(parModel).find(".quizze_ID").val();
                ...
                /* Quizze Order Score */
                var info_order_Score = $(parModel).find(".quizze_Quizze_Order").val();
                /* Quizze Active */
                ...
                console.log("childEdite1", InfoEdite)
                console.log("childEdite2", allDataEdite)
                ...
                $(childEdite).each((childEle, childVal) => {
                    ...
                    var ques_less = $(question_edit_lesson).text().trim();
                    /* ########### */
