...
<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal"
    data-bs-target="#kt_modal_create_campaign">Add Chapter</a>
<!--end::Action-->
        ...
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
                    ...
                    <!--end::Nav-->
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('add_chapter') }}" class="mx-auto w-100 mw-600px pt-15 pb-10"
                                ...
                                <div>
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" class="form-control" name="chapter_name"
                                            placeholder="Chapter Name" value="" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    ...
                                    <div class="idea">
                                        <div class="section_idea my-2 d-flex align-items-center">
                                            ...
                                            <input type="number" name="duration[]"
                                                class="form-control mx-2 form-control-lg">
                                            <span>Dayes</span>
                                        </div>
...
<script>
    $(document).ready(function() {
        console.log("ssssssssssssssfirst")
