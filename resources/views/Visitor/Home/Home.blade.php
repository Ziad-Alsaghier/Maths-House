...
.curve-line {
  position: absolute;
  top: 50%;
  left: calc(33.333% + 15px); /* Adjust the percentage based on your needs */
  width: 100%;
  height: 2px;
...
.curve-line::before {
  ...
  top: -5px;
  left: 0;
  width: calc(33.333% - 15px); /* Adjust the percentage based on your needs */
  height: 10px;
  border-radius: 50%;
      ...
      <div class="container">
        <div class="main-inner">
          ...
          <h1>Build skills with experts anytime <span class>,</span></h1>
                ...
                <button type="button" class="btn btn-danger">Find Courses</button>
          </div>
...
<section  id="Customer">
    ...
    <div class="col-md-3 mb-2">
        ...
        <div class="content d-flex justify-content-between">
            <div class="d-flex justify-content-center align-items-center">
            <img
                src="{{asset('assets/img/avatars/Neutral Profile Picture 22.png')}}"
                alt=""
            />
        ...
        <p class="p-2 pt-3">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam mi diam, egestas sed tellus sed, aliquet cursus arcu”</p>
        </div>
    </div>
    <div class="col-md-3 mb-2">
        <div class="main-header">
...
<div class="modal show_popup fade show " id="modalCenter" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <img style="width: 100%; height: 200px;" src="{{asset('images/MarketingPopup/' . $item->image)}}" />
