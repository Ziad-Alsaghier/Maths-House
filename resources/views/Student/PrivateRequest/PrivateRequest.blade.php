...
@section('page_content')
    ...
    <div class="swal2-container success_alert d-none swal2-center swal2-backdrop-show " id="alert_success"
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-html-container"
            ...
            <div class="swal2-html-container success_text" id="swal2-html-container" style="display: block;">
    ...
    <div class="d-flex my-3">
        ...
        <button class="btn btn-primary mx-2 search_btn">
            Search
        </button>
    </div>
    ...
    <div class="swal2-container faild_alert d-none swal2-center swal2-backdrop-show " id="alert_danger"
        style="overflow-y: auto;">
        <div aria-labelledby="swal2-title" aria-describedby="swal2-html-container"
            class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog"
            aria-live="assertive" aria-modal="true" style="display: grid;"><button type="button" class="swal2-close"
            ...
            <h2 class="swal2-title" id="swal2-title" style="display: block;">Faild!</h2>
            <div class="swal2-html-container faild_text" id="swal2-html-container" style="display: block;">
            ...
            <div class="swal2-actions" style="display: flex;">
                <div class="swal2-loader"></div>
                <button type="button" class="swal2-confirm btn btn-primary" id="btn_hidden2" aria-label=""
                    style="display: inline-block;">OK</button>
                <button type="button" class="swal2-deny" aria-label="" style="display: none;">No</button><button
                    type="button" class="swal2-cancel" aria-label="" style="display: none;">Cancel</button>
            </div>
    ...
    <script>
        ...
        courses = JSON.parse(courses.value);
        ...
        let btn_hidden = document.getElementById('btn_hidden');
        let btn_hidden2 = document.getElementById('btn_hidden2');
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            search_btn.addEventListener('click', () => {
                $.ajax({
                    url: "{{ route('private_req_api') }}",
                    dataType: "json",
                    data: {course_id: sel_course.value},
                    success: function(data) {
                        ...
                        splide.mount();
                        $(".btn_lesson_rese").click(function() {
                            var lessonID = $(this).closest(".lesson").find("#lessonID")
                                .val();
                            console.log(lessonID)

                            $.ajax({
                                type: "GET",
                                url: "{{ route('private_req_book_api') }}",
                                data: {
                                    id: lessonID
                                },
                                success: function(data) {
                                    let key = Object.keys(data)[0];
                                    let faild_alert = document
                                        .querySelector('.faild_alert');
                                    let success_alert = document
                                        .querySelector('.success_alert');
                                    let success_text = document
                                        .querySelector('.success_text');
                                    let faild_text = document.querySelector(
                                        '.faild_text');
                                    if (key == 'faild') {
                                        faild_text.innerText = data.faild;
                                        faild_alert.classList.remove(
                                            'd-none')
                                    } else {
                                        success_text.innerText = data
                                            .success;
                                        success_alert.classList.remove(
                                            'd-none')
                                    }
                                }
                            })
            ...
            // $("btn_lesson_rese").each((val, ele) => {
            //     var btnC = $(ele).attr("id")
            //     console.log(btnC)
            // })
            // $(".btn_lesson_rese").each(
            //     (elee, vall) => {
            //         console.log(elee)
            //         console.log(vall)
            //     })

            // $("btn_lesson_rese").click(
