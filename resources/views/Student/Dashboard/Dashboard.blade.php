...
<div class="swal2-container success_alert d-none swal2-center swal2-backdrop-show " id="alert_success" style="overflow-y: auto;">
...
<div class="swal2-container faild_alert d-none swal2-center swal2-backdrop-show " id="alert_danger" style="overflow-y: auto;">
    <div aria-labelledby="swal2-title" aria-describedby="swal2-html-container"
        class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive"
        aria-modal="true" style="display: grid;"><button type="button" class="swal2-close"
            aria-label="Close this dialog" style="display: none;">×</button>
...
<script src="{{ asset('assets/vendor/libs/sweetalert2/sweetalert2.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.getJSON("{{route('stu_sessions_api')}}", function(data) {
                console.log(data)
                ...
                $(".btn_lesson_rese").click(function() {
                    var lessonID = $(this).closest(".lesson").find("#lessonID").val();
