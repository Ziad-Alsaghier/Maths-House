                     ...
                     <div class="wrapper">
                         ...
                         <section>
                             <form class="col-12 d-flex flex-column justify-content-center align-items-center"
                                 style="row-gap: 3rem" action="{{route('payment_package', ['id' => $package->id])}}" method="POST"
                                         ...
                                         <label class="upload_img d-none" style="cursor: pointer;" for="reset_img">
                                             ...
                                             <div class="radio-button">
                                                 ...
                                                 <label for="radio{{ $item->id }}" class="radio-button__label">
                                                     <div class="">
                                                         <img width="30px"
                                                             src="{{ asset('images/payment/' . $item->logo) }}"
                                                             alt="">
                                                         <span class="radio-button__custom"></span>
                                                         {{ $item->payment }}
                                                     </div>
                                 ...
                                 <div class="col-9 d-flex align-items-start justify-content-between"
                                     ...
                                     <div id="selImg" class="d-flex align-items-center justify-content-center"
                                         style="height: 70px; column-gap: 0.3rem">
                                         <h3 style="color: #CF202F;font-weight: 700">Upload Receipt</h3>
                                         <img width="35px" src="{{ asset('images/payment/UploadIcon.svg') }}"
                                             alt="">
                                     </div>
                                     <input type="file" style="visibility: hidden;width: 2px;" id="img"
                                 ...
                                 <div class="col-9 d-flex align-items-center justify-content-start"
                                     ...
                                     <label class="containerCheck">
                                         ...
                                         <input type="checkbox" class="walletRadio" name="payment_method_id"
                                             value="Wallet">
                                         <div class="checkmark"></div>
                                     </label>
                                     <h3 style="color: #727272;font-weight: 700">Using Wallet</h3>
                             ...
                             {{-- <form action="{{route('package_use_promocode')}}"> --}}
