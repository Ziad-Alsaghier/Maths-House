				...
				<div class="col-lg-4 col-xl-4">
					<div class="order_sidebar_widget mb30">
						...
						<ul>
							...
							<li><p>{{$package->name}} <span class="float-right">{{$package->price}}</span></p></li> 
							 
							<li class="subtitle"><p>Subtotal <span class="float-right">Subtotal</span></p></li>
							<li class="subtitle"><p>Total <span class="float-right totals color-orose">${{$package->price}}</span></p></li>
						</ul>
					</div>
					...
					<form action="{{route('payment_package', ['id' => $package->id])}}" method="POST" enctype="multipart/form-data">
						...
						<div class="payment_widget">
							<div class="ui_kit_checkbox style2">
								...
								<label class="upload_img d-none" style="cursor: pointer;">
									<div class="bt_details">
										<p>
											{{$item->description}}
										</p>
									</div>
									<label  for="reset_img" class="btn btn-info">
